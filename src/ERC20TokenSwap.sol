...
# allowed TokenSwap to withdraw amount tokens by calling approve prior to TokenSwap calling transferFrom
...
contract ERC20TokenSwap {
    ...
    function swap(IERC20 token1, IERC20 token2, address owner1, address owner2, uint256 amount1, uint256 amount2)
        public
    {
